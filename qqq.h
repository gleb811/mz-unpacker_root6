...
// Fri Apr 12 14:37:18 2019 by ROOT version 6.16/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxHits = 1;
...
#ifdef qqq_cxx
qqq::qqq(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/onl/Panda/xx19101112908.hld.root_calibrated.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/onl/Panda/xx19101112908.hld.root_calibrated.root");
      }
      f->GetObject("T",tree);
...
Int_t qqq::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t qqq::LoadTree(Long64_t entry)
{
