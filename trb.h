...
// Thu Mar 24 17:28:14 2016 by ROOT version 6.04/14
// from TTree T/UMainz TRBv3 HLD Data (Calibrated)
// found on file: xx16083125752.hld.root_calibrated.root
//////////////////////////////////////////////////////////
...
class trb : public TSelector {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
//   const Int_t kMaxHits = 205;
   const static Int_t kMaxHits = 205;
